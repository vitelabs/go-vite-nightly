...
describe("test version11 upgrade", () => {
  ...
  it("test FundContract placeOrder - MarketOrder - Directly Fill ", async () => {
    const initViteAmount = "100000000000000000000000"; // 10w VITE
    const initVttAmount = "100000000000000000000000";  // 10w VTT
  ...
  it("test FundContract placeOrder - MarketOrder with enough balance - fill multi Limit Orders ", async () => {
    ...
    await dex.placeOrder(user2FundContract, tradeToken, quoteToken, sideBuy, orderMarket, price3, quantityMarketOrder); // sell 6 VTT
